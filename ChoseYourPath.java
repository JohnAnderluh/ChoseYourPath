...
public class ChoseYourPath {
  public static void main(String[] args) {
    ...
    if (answer.equals("no")) {
      ...
      System.out.println("Do you comfort it or do you to erase the mad libs? (comfort/erase)");
      answer = sc.nextLine();
    }
    if (answer.equals("comfort")) {
      System.out
          .println("You become freinds with the " + userInput2 + " " + userInput3 + ". You live happily ever after.");
    } else if (answer.equals("no")) {
